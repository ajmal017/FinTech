...
class Trader(object):
    ...
    def _update_reward(self, action_code, action_status, position):
        #self.reward = self._calculate_reward_v3(action_code, action_status, position)
        self.reward = self.profits - self.prev_profits
        self.prev_profits = self.profits
    ...
    @staticmethod
    def _calculate_reward_v2(self, action_status, position):
    ...
    @staticmethod
    def _calculate_reward_v3(self, action_status, position):
        reward = self.profits - self.prev_profits
        self.prev_profits = self.profits
        return reward
