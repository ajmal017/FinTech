...
stock_spider_parser.add_argument("-s", "--start", default="1998-01-01")
...
future_spider_parser.add_argument("-s", "--start", default="1998-01-01")
...
model_launcher_parser.add_argument("-s", "--start", default="1998-01-01")
